...
import { Sparkles, User, Lock, ArrowRight, Loader2, BookOpen } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in-95 duration-700">
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-zinc-800 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-black text-gray-400 dark:text-zinc-600 uppercase tracking-widest pl-2">密码 (模拟环境)</label>
              <div className="relative">
          ...
          >
            {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : (
              <>
                {isLogin ? '登录工作台' : '注册并启动'} <ArrowRight className="w-4 h-4" />
              </>
            )}
          </button>
